...
- (UIButton *)rightBarBtn {
    if (!_rightBarBtn) {
        ...
        [rightBarBtn setBackgroundImage:[UIImage imageNamed:@"serach"] forState:UIControlStateNormal];
...
- (UIButton *)leftBarBtn {
    if (!_leftBarBtn) {
        ...
        [leftBarBtn setBackgroundImage:[UIImage imageNamed:@"map"] forState:UIControlStateNormal];
...
- (void)touchLeftBarBtn:(UIButton *)btn {
    ...
    [self.navigationController pushViewController:[[CitysSelectedVC alloc]init] animated:YES];
